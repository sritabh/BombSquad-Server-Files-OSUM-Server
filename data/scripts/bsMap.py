...
class Map(bs.Actor):
    ...
    def __init__(self, vrOverlayCenterOffset=None):
        ...
        def text():
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':u'\ue043Check Your Rank On This Server\ue043',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                ...
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':'To Do Backflip press Punch and Jump together or \nSwipe Punch then Jump',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'color':((0+random.random()*1.0),(0+random.random()*1.0),(0+random.random()*1.0)),
                              ...
                              'hAlign':'center',
                              'vAttach':'bottom'})
                bs.animate(t,'opacity',{15000: 0.0,15500: 1.0,24500: 1.0,25000: 0.0})
                bs.gameTimer(25000,t.delete)
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':'Tip:- Do not release Jump before landing while doing backflip\nfor better Damage',
                              'scale':1.0,
                              'maxWidth':0,
                              'position':(0,139),
                              'shadow':0.5,
                              ...
                              'hAlign':'center',
                              'vAttach':'bottom'})
                bs.animate(t,'opacity',{27000: 0.0,27500: 1.0,37500: 1.0,38000: 0.0})
                bs.gameTimer(38000,t.delete)
...
class DeathCircle(Map):
    import deathcircledef as defs
    name = "DeathCircle"
    playTypes = ['melee', 'football', 'teamFlag', 'keepAway']

    @classmethod
    def getPreviewTextureName(cls):
        return 'circleOutlineNoAlpha'
    ...
    def __init__(self):
        ...
        bs.newNode('terrain',
                   attrs={'model':self.preloadData['vrFillModel'],
                          ...
                          'background':True,
                          'colorTexture':self.preloadData['tex']})
        circle = bs.newNode('locator',attrs={'shape': 'circleOutline', 'position':(-0.1001374046, 0.04180340146, 0.1095578275), 'size':[9.0], 'drawBeauty': False,})
