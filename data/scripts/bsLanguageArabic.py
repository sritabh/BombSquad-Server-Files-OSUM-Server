...
values = {
    ...
    'editProfileWindow':{
        ...
        'globalProfileInfoText':('ويضمن ملامح لاعب العالمية لديها فريدة من نوعها\n'
                                 'أسماء في جميع أنحاء العالم. وتشمل أيضا الرموز المخصصة.'),
    ...
    'gatherWindow':{
        ...
        'aboutText':'حول',
        'addressFetchErrorText':'<عناوين جلب الأخطاء>',
        ...
        'friendPromoCodeInstructionsText':('لاستخدامه، افتح ${APP_NAME} وانتقل الي "الاعدادات->متقدم->ادخل الكود الترويجي".\n'
                                           'القي نظرة علي bombsquadgame.com لايجاد روابط تنزيل كلاالمنصات المعتمدة.'),
        ...
        'friendPromoCodeWhereToEnterText':'(في "الاعدادات->متقدم->ادخل الكود الترويجي")',
        ...
        'partyInviteGooglePlayExtraText':'(راجع علامة التبويب "غوغل بلاي" في نافذة "الجميع")',
    ...
    'helpWindow':{
        ...
        'punchInfoText':('- لكمة -\n'
                         'اللكمات تفعل المزيد من الضرر\n'
                         'أسرع القبضات الخاصة بك تتحرك، لذلك\n'
                         'تشغيل وتدور مثل مجنون.'),
        'runInfoText':('- يركض -\n'
    ...
    'internal':{
        ...
        'willTimeOutText':'(سوف مهلة إذا الخمول)'
    },
    'jumpBoldText':'اقفز',
    'jumpText':'قفز',
    'keepText':'احتفظ',
    ...
    'kickText':'ركل',
    'kickVoteFailedNotEnoughVotersText':'لا يكفي لاعبين للتصويت.',
    ...
    'translations':{
        ...
        'serverResponses':{
            ...
            'BombSquad Pro unlocked!':'بومبسكاد برو مقفلة!',
