...
class BombFactory(object):
    ...
    def __init__(self):
        ...
        self.gluebombModel = bs.getModel('footballStadium')
...
class Blast(bs.Actor):
    ...
    def __init__(self, position=(0,1,0), velocity=(0,0,0), blastRadius=2.0,
        ...
        if self.blastType == 'tbomb':
            scorch.color = (1,1,1.5)
        if self.blastType == 'weedbomb':
            scorch.color = (1,1,1.5)
        if self.blastType == 'gluebomb':
            scorch.color = (0,1,0)
...
class Bomb(bs.Actor):
    ...
    def __init__(self, position=(0,1,0), velocity=(0,0,0), bombType='normal',
        ...
        if not bombType in ('ice','impact','weedbomb','tbomb','gluebomb','landMine','normal','sticky','tnt'):
        ...
        elif self.bombType == 'weedbomb': self.blastRadius *= 0.5
    ...
    def _handleHit(self, msg):
        ...
        if (not self._exploded and not isPunch
            or self.bombType in ['tbomb','weedbomb','gluebomb','impact','landMine']):
