...
class PowerupFactory(object):
    ...
    def getRandomPowerupType(self,forceType=None,excludeType2=[],excludeTypes=[]):
        """
...
class Powerup(bs.Actor):
    ...
    def __init__(self,position=(0,1,0),powerupType='tripleBombs',expire=True):
        ...
        elif powerupType == 'invisibility': tex = factory.texInvisibility
        elif powerupType == 'star': tex = factory.texStar
        elif powerupType == 'curse': tex = factory.texCurse
        elif powerupType == 'tbomb': tex = factory.textbomb
